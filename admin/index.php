                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="active has-sub">
                         ...
                         <li>
                            <a href="bins.php">
                                <i class="fas fa-cog"></i>Send Bins</a>
                        </li>
                        <li>
                            <a href="antibot.php">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="statistic__item statistic__item--green">
                                ...
                                <span style="color:#fff;" class="desc">Klik</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--blue">
                                ...
                                <span style="color:#fff;" class="desc">Login Apple</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                ...
                                <span style="color:#fff;" class="desc">Email Akses</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--orange">
                                ...
                                <span style="color:#fff;" class="desc">Kartu Kredit</span>
                                <div class="icon">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="statistic__item statistic__item--blue">
                                ...
                                <span style="color:#fff;" class="desc">BOT Kontol</span>
                                <div class="icon">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-1 m-b-25">Kartu Kredit [<?php echo $total_cc;?>]</h2>
